...
public class ClassRoom {
    ...
    public ClassRoom(int classRuleId, int minAge, int maxAge, int maxClassSize, int groupSize, String studentIds, String studentName, String teacherIds, String teacherName) {
